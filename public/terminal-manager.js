...
function showSession(sessionId) {
    ...
    // Refresh git panel for this session's project
    const gitSession = sessionMap.get(sessionId);
    if (typeof refreshGitPanel === "function" && gitSession?.projectPath) {
        refreshGitPanel(gitSession.projectPath);
    }
